...
# DA3
echo "Downloading DA3 weights..."
huggingface-cli download depth-anything/DA3NESTED-GIANT-LARGE-1.1  --local-dir ./DA3 --local-dir-use-symlinks False


# you will see 7 files under `./weights` when finished
# - model.pt
# - dino_salad.ckpt
