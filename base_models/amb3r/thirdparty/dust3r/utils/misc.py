...
# --------------------------------------------------------
# References:
#   https://github.com/HengyiWang/amb3r/blob/main/thirdparty/dust3r/utils/misc.py
...
def transpose_to_landscape(head, activate=True):
    ...
    def wrapper_no(decout, true_shape):
        B = len(true_shape)
        assert true_shape[0:1].allclose(true_shape), f'true_shape must be all identical:{true_shape}'
