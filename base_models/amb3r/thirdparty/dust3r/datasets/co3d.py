...
# --------------------------------------------------------
# References:
#   https://github.com/HengyiWang/amb3r/blob/main/thirdparty/dust3r/datasets/co3d.py
...
class Co3d(BaseStereoViewDataset):
    def __init__(self, mask_bg=True, *args, ROOT, **kwargs):
        ...
        with open(osp.join(self.ROOT, f'selected_seqs_{self.split}.json'), 'r') as f:
            ...
            self.scenes = {k: v for k, v in self.scenes.items() if len(v) > 0} # k is class (apple), v is corresponding list
