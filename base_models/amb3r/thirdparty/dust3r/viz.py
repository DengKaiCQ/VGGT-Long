...
# --------------------------------------------------------
# References:
#   https://github.com/HengyiWang/amb3r/blob/main/thirdparty/dust3r/viz.py
...
class SceneViz:
    ...
    def show(self, viewer=None, point_size=2, block=True):
        self.scene.show(viewer, line_settings={'point_size': point_size}, block=True)
