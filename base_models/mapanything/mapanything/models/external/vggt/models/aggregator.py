...
# References:
#   https://github.com/facebookresearch/map-anything/blob/main/mapanything/models/external/vggt/models/aggregator.py
    ...
    def __build_patch_embed__(
        ...
        if "conv" in patch_embed:
            ...
            if os.path.exists(dinov2_path):
                ...
                self.patch_embed = torch.hub.load(dinov2_path, patch_embed, source='local')
            else:
