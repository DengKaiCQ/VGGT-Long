...
# References:
#   https://github.com/facebookresearch/map-anything/blob/main/mapanything/third_party/vggsfm_utils.py
...
def generate_rank_by_dino(
    ...
    # Load DINO model
    # Use local dinov2 to avoid hub issues
    import os
    current_dir = os.path.dirname(os.path.abspath(__file__))
    # gradio/base_models/mapanything/mapanything/third_party -> gradio/LoopModels/dinov2
