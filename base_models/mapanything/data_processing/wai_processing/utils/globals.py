...
# References:
#   https://github.com/facebookresearch/map-anything/blob/main/data_processing/wai_processing/utils/globals.py
...
WAI_SPOD_RUNS_PATH = "/ai4rl/fsx/xrtech/code/spod_runs"
